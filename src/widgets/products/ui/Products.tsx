  ...
  return (
    <section className="mt-[80px] mb-10">
      <div className="container mx-auto flex justify-between items-center mb-10">
        <h1 className="text-[36px] font-semibold">Our products.</h1>
        <button className="text-[16px] text-green-600 font-medium py-[11px] px-[33px] border-1 border-gray-300 rounded-lg hover:border-green-600 transition">
          View all (12)
        </button>
      </div>
